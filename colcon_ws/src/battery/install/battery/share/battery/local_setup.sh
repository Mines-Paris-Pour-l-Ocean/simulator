...
: ${AMENT_CURRENT_PREFIX:="/home/mig/simulator/colcon_ws/src/battery/install/battery"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/battery/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/battery/environment/path.sh"
